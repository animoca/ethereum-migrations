...
module.exports = Contract_deploy('FxERC20FixedSupplyRootTunnel@0.1.2', {
  ...
  args: [
    ...
    {name: 'ChildTokenLogic', value: async (hre) => (await hre.companionNetworks['polygon'].deployments.get('FxERC20FixedSupply@0.1.2')).address},
