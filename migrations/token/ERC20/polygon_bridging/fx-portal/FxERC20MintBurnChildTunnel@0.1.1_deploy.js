...
module.exports = Contract_deploy('FxERC20MintBurnChildTunnel@0.1.1', {
  ...
  args: [
    ...
    {name: 'ChildTokenLogic', value: getContractAddress('FxERC20MintBurn@0.1.1')},
...
module.exports.dependencies = ['FxERC20MintBurn@0.1.1_deploy', 'ForwarderRegistry@0.3.1_deploy'];
