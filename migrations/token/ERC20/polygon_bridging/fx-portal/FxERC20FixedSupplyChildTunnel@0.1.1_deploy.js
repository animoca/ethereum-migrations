...
module.exports = Contract_deploy('FxERC20FixedSupplyChildTunnel@0.1.1', {
  ...
  args: [
    ...
    {name: 'ChildTokenLogic', value: getContractAddress('FxERC20FixedSupply@0.1.1')},
...
module.exports.dependencies = ['FxERC20FixedSupply@0.1.1_deploy', 'ForwarderRegistry@0.3.1_deploy'];
