...
module.exports = Contract_deploy('FxERC20MintBurnRootTunnel@0.1.1', {
  ...
  args: [
    ...
    {name: 'ChildTokenLogic', value: async (hre) => (await hre.companionNetworks['polygon'].deployments.get('FxERC20MintBurn@0.1.1')).address},
