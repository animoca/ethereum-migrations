...
module.exports = Contract_deploy('FxERC20MintBurnChildTunnel@0.1.0', {
  ...
  args: [
    ...
    {name: 'ChildTokenLogic', value: getContractAddress('FxERC20MintBurn@0.1.0')},
...
module.exports.dependencies = ['FxERC20MintBurn@0.1.0_deploy', 'ForwarderRegistry@0.3.0_deploy'];
